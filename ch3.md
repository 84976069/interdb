...
PostgreSQL支持两个有趣的技术和实用的特性，即[外部数据包(Foreign Data Wrappers) (FDW)](http://www.postgresql.org/docs/current/static/fdwhandler.html)和[并行查询Parallel Query](https://www.postgresql.org/docs/current/static/parallel-query.html); 他们将在[第4章](ch4.md)中介绍。
...
![Fig. 3.1. Query Processing.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-01.png?raw=true)
...
![Fig. 3.2. An example of a parse tree.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-02.png?raw=true)
...
![Fig. 3.3. An example of a query tree.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-03.png?raw=true)
...
![Fig. 3.4. An example of the rewriter stage.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-04.png?raw=true)
...
**图. 3.5. 计划树示例，计划树与EXPLAIN命令的结果之间的关系**![Fig. 3.5. A simple plan tree and the relationship between the plan tree and the result of the EXPLAIN command.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-05.png?raw=true)

计划树由称为 *计划节点(plan nodes)* 的元素组成，并连接到 *PlannedStmt* 结构的 Plantree 列表。这些元素在 [plannodes.h](https://github.com/postgres/postgres/blob/master/src/include/nodes/plannodes.h) 中定义。细节将在3.3.3节(和3.5.4.2节)中描述。
...
![Fig. 3.6. The relationship among the executor, buffer manager and temporary files.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-06.png?raw=true)
...
> :pushpin: 如果可以使用 [Index-Only Scans](https://www.postgresql.org/docs/10/static/indexes-index-only-scans.html)([第7章](ch7.md)中描述)，则不估计'‘table cpu cost’和'table IO cost’。
...
> ![Fig. 3.7. Buckets and histogram_bounds.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-07.png?raw=true)
...
> ![Fig. 3.8. Index correlation.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-08.png?raw=true)
...
![Fig. 3.9. An example of flattening AND/OR expressions.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-09.png?raw=true)
...
![Fig. 3.10. How to get the cheapest path of Example 1.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-10.png?raw=true)
...
![Fig. 3.11. How to get the cheapest path of Example 1 (continued from Fig. 3.10).](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-11.png?raw=true)
...
![Fig. 3.12. How to get the cheapest path of Example 2.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-12.png?raw=true)

**图. 3.13. 示例2中如何获得最优路径(从图3.12继续)**

![Fig. 3.13. How to get the cheapest path of Example 2 (continued from Fig. 3.12).](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-13.png?raw=true)
...
![Fig. 3.14. How to get the cheapest path of Example 2 (continued from Fig. 3.13).](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-14.png?raw=true)
...
![Fig. 3.15. Examples of plan trees.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-15.png?raw=true)
...
![Fig. 3.16. Nested loop join.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-16.png?raw=true)
...
![Fig. 3.17. Materialized nested loop join.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-17.png?raw=true)
...
![Fig. 3.18. Indexed nested loop join.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-18.png?raw=true)
...
![Fig. 3.19. The three variations of the nested loop join with an outer index scan.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-19.png?raw=true)
...
![Fig. 3.20. Merge join.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-20.png?raw=true)
...
![Fig. 3.21. Materialized merge join.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-21.png?raw=true)
...
![Fig. 3.22. The three variations of the merge join with an outer index scan.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-22.png?raw=true)
...
![Fig. 3.23. The build phase in the in-memory hash join.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-23.png?raw=true)
...
![Fig. 3.24. The probe phase in the in-memory hash join.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-24.png?raw=true)
...
![Fig. 3.25. Multiple batches in hybrid hash join.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-25.png?raw=true)
...
![Fig. 3.26. The build phase of the hybrid hash join in the first round.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-26.png?raw=true)
...
![Fig. 3.27. The probe phase of the hybrid hash join in the first round.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-27.png?raw=true)
...
![Fig. 3.28. The build and probe phases in the second round.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-28.png?raw=true)
...
![Fig. 3.29. The build and probe phases in the third and the last rounds.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-29.png?raw=true)
...
![Fig. 3.30. Join access paths.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-30.png?raw=true)
...
![Fig. 3.31. How to get the cheapest access path using dynamic programming.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-31.png?raw=true)
...
![Fig. 3.32. The PlannerInfo and RelOptInfo after processing in Level 1.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-32.png?raw=true)
...
![Fig. 3.33. The PlannerInfo and RelOptInfo after processing in Level 2.](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-33.png?raw=true)
...
![img](https://github.com/84976069/interdb/blob/master/imgs/ch3/fig-3-34.png?raw=true)
