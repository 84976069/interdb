...
![Fig. 3.1. Query Processing.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-01.png?raw=true)
...
![Fig. 3.2. An example of a parse tree.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-02.png?raw=true)
...
![Fig. 3.3. An example of a query tree.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-03.png?raw=true)
...
![Fig. 3.4. An example of the rewriter stage.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-04.png?raw=true)
...
**图. 3.5. 计划树示例，计划树与EXPLAIN命令的结果之间的关系**![Fig. 3.5. A simple plan tree and the relationship between the plan tree and the result of the EXPLAIN command.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-05.png?raw=true)
...
![Fig. 3.6. The relationship among the executor, buffer manager and temporary files.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-06.png?raw=true)
...
> ![Fig. 3.7. Buckets and histogram_bounds.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-07.png?raw=true)
...
> ![Fig. 3.8. Index correlation.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-08.png?raw=true)
...
![Fig. 3.9. An example of flattening AND/OR expressions.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-09.png?raw=true)
...
![Fig. 3.10. How to get the cheapest path of Example 1.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-10.png?raw=true)
...
![Fig. 3.11. How to get the cheapest path of Example 1 (continued from Fig. 3.10).](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-11.png?raw=true)
...
![Fig. 3.12. How to get the cheapest path of Example 2.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-12.png?raw=true)

**图. 3.13. 示例2中如何获得最优路径(从图3.12继续)**

![Fig. 3.13. How to get the cheapest path of Example 2 (continued from Fig. 3.12).](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-13.png?raw=true)
...
![Fig. 3.14. How to get the cheapest path of Example 2 (continued from Fig. 3.13).](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-14.png?raw=true)
...
![Fig. 3.15. Examples of plan trees.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-15.png?raw=true)
...
![Fig. 3.16. Nested loop join.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-16.png?raw=true)
...
![Fig. 3.17. Materialized nested loop join.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-17.png?raw=true)
...
![Fig. 3.18. Indexed nested loop join.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-18.png?raw=true)
...
![Fig. 3.19. The three variations of the nested loop join with an outer index scan.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-19.png?raw=true)
...
![Fig. 3.20. Merge join.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-20.png?raw=true)
...
![Fig. 3.21. Materialized merge join.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-21.png?raw=true)
...
![Fig. 3.22. The three variations of the merge join with an outer index scan.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-22.png?raw=true)
...
![Fig. 3.23. The build phase in the in-memory hash join.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-23.png?raw=true)
...
![Fig. 3.24. The probe phase in the in-memory hash join.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-24.png?raw=true)
...
![Fig. 3.25. Multiple batches in hybrid hash join.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-25.png?raw=true)
...
![Fig. 3.26. The build phase of the hybrid hash join in the first round.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-26.png?raw=true)
...
![Fig. 3.27. The probe phase of the hybrid hash join in the first round.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-27.png?raw=true)
...
![Fig. 3.28. The build and probe phases in the second round.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-28.png?raw=true)
...
![Fig. 3.29. The build and probe phases in the third and the last rounds.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-29.png?raw=true)
...
![Fig. 3.30. Join access paths.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-30.png?raw=true)
...
![Fig. 3.31. How to get the cheapest access path using dynamic programming.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-31.png?raw=true)
...
![Fig. 3.32. The PlannerInfo and RelOptInfo after processing in Level 1.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-32.png?raw=true)
...
![Fig. 3.33. The PlannerInfo and RelOptInfo after processing in Level 2.](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-33.png?raw=true)
...
![img](https://github.com/yonj1e/interdb/blob/master/imgs/ch3/fig-3-34.png?raw=true)
