...
> #### ANSI SQL-92 隔离级别
>
> ![ANSI SQL-92 Isolation Levels](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/si-5-01.png?raw=true)
...
![Fig. 5.2. Tuple structure.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-02.png?raw=true)
...
![Fig. 5.3. Representation of tuples.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-03.png?raw=true)
...
![Fig. 5.4. Tuple insertion.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-04.png?raw=true)
...
![Fig. 5.5. Tuple deletion.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-05.png?raw=true)
...
![Fig. 5.6. Update the row twice.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-06.png?raw=true)
...
![Fig. 5.7. How the clog operates.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-07.png?raw=true)
...
> **图. 5.8. 事务快照示例**
>
> ![Fig. 5.8. Examples of transaction snapshot representation.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-08.png?raw=true)
>
...
![Fig. 5.9. Transaction manager and transactions.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-09.png?raw=true)
...
![Fig. 5.10. Scenario to describe visibility check.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-10.png?raw=true)
...
![code-5-01](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/code-5-01.png?raw=true)
...
![code-5-02](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/code-5-02.png?raw=true)
...
![Fig. 5.11. Three internal blocks in ExecUpdate.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-11.png?raw=true)
...
![code-5-03](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/code-5-03.png?raw=true)
...
![code-5-04](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/code-5-04.png?raw=true)
...
![code-5-05](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/code-5-05.png?raw=true)
...
![Fig. 5.12. Write-Skew schedule and its precedence graph.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-12.png?raw=true)
...
![Fig. 5.14. Relationship between the index and table in the scenario shown in Fig. 5.13.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-14.png?raw=true)
...
![Fig. 5.15. SIREAD locks and rw-conflicts, and schedule of the scenario shown in Fig. 5.13.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-15.png?raw=true)
...
![Fig. 5.19. False-positive anomaly (2) – Index scan using the same index page.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-19.png?raw=true)
...
![Fig. 5.21. Freeze process.](https://github.com/yonj1e/interdb/blob/master/imgs/ch5/fig-5-21.png?raw=true)
