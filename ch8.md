## 第8章 缓冲区管理器(buffer manager){docsify-ignore} 
...
![Fig. 8.1. Relations between buffer manager, storage, and backend processes.](https://github.com/84976069/interdb/blob/master/imgs/ch8/fig-8-01.png?raw=true)
...
![Fig. 8.2. How a backend reads a page from the buffer manager.](https://github.com/84976069/interdb/blob/master/imgs/ch8/fig-8-02.png?raw=true)
...
![Fig. 8.3. Buffer manager's three-layer structure.](https://github.com/84976069/interdb/blob/master/imgs/ch8/fig-8-03.png?raw=true)
...
![Fig. 8.4. Buffer table.](https://github.com/84976069/interdb/blob/master/imgs/ch8/fig-8-04.png?raw=true)
...
![](https://github.com/84976069/interdb/blob/master/imgs/ch8/buf-8-01.jpg?raw=true)

另外，脏页被表示为'X'。例如，一个unpinned缓冲区描述符由![脏描述符由表示](https://github.com/84976069/interdb/blob/master/imgs/ch8/buf-8-02.jpg?raw=true)表示。
...
![Fig. 8.5. Buffer manager initial state.](https://github.com/84976069/interdb/blob/master/imgs/ch8/fig-8-05.png?raw=true)
...
![Fig. 8.6. Loading the first page.](https://github.com/84976069/interdb/blob/master/imgs/ch8/fig-8-06.png?raw=true)
...
![Fig. 8.7. Two processes simultaneously acquire the respective partitions of BufMappingLock in exclusive mode to insert new data entries.](https://github.com/84976069/interdb/blob/master/imgs/ch8/fig-8-07.png?raw=true)
...
![Fig. 8.8. Accessing a page stored in the buffer pool.](https://github.com/84976069/interdb/blob/master/imgs/ch8/fig-8-08.png?raw=true)
...
![Fig. 8.9. Loading a page from storage to an empty slot.](https://github.com/84976069/interdb/blob/master/imgs/ch8/fig-8-09.png?raw=true)
...
![Fig. 8.10. Loading a page from storage to a victim buffer pool slot.](https://github.com/84976069/interdb/blob/master/imgs/ch8/fig-8-10.png?raw=true)
...
![Fig. 8.11. Loading a page from storage to a victim buffer pool slot (continued from Fig. 8.10).](https://github.com/84976069/interdb/blob/master/imgs/ch8/fig-8-11.png?raw=true)
...
![Fig. 8.12. Clock Sweep.](https://github.com/84976069/interdb/blob/master/imgs/ch8/fig-8-12.png?raw=true)
